 ...
 */
final class Version20240321105142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resume (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, summary LONGTEXT NOT NULL, skills LONGTEXT NOT NULL, professional_experience LONGTEXT NOT NULL, education LONGTEXT NOT NULL, INDEX IDX_60C1D0A0CCFA12B8 (profile_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
